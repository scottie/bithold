...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bithold", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bithold</b> version", 0));
...
"Copyright \302\251 2017-2018 The Bithold developers", 0));
