...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        label_3 = new QLabel(frameDarksend);
        ...
        formLayout->setWidget(2, QFormLayout::FieldRole, darksendProgress);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, darksendEnabled);
        ...
        bitholdlogo = new QLabel(frame_2);
        bitholdlogo->setObjectName(QStringLiteral("bitholdlogo"));
        bitholdlogo->setPixmap(QPixmap(QString::fromUtf8(":/images/bitholdlogo")));
        bitholdlogo->setScaledContents(false);
        bitholdlogo->setAlignment(Qt::AlignCenter);
        bitholdlogo->setMargin(60);

        verticalLayout->addWidget(bitholdlogo);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Bithold network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelDarksendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Bithold network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        label_3->setText(QApplication::translate("OverviewPage", "DarkSend feature may work incorrectly. Please use Darksend at your own risk ", 0));
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 BHD / 0 Rounds", 0));
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Bithold network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        bitholdlogo->setText(QString());
    } // retranslateUi
